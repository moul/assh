...
Connected to 127.0.0.1: seq=0 time=321Âµs protocol=tcp port=22
Connected to 127.0.0.1: seq=1 time=501Âµs protocol=tcp port=22
Connected to 127.0.0.1: seq=2 time=550Âµs protocol=tcp port=22
Connected to 127.0.0.1: seq=3 time=641Âµs protocol=tcp port=22

--- localhost assh ping statistics ---
4 packets transmitted, 4 packets received, 0.00% packet loss
round-trip min/avg/max = 321Âµs/503.25Âµs/641Âµs
```
